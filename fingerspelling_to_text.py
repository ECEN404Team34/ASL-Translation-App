...
score_min1_counter = 0
score_min2_counter = 0
...
def visualize_boxes_and_labels_on_image_array(
    ...
    min_score_thresh=.5,
    agnostic_mode=False,
    line_thickness=4, #This line modifies line thickness
    mask_alpha=.4,
  ...
  for i in range(boxes.shape[0]):
    ...
    ######## COUNTER FUNCTION
    global score_min1_counter
    global score_min2_counter
    #print(scores[i]*100)
    if scores[i]*100 >= score_min1:
        score_min1_counter += 1
    if scores[i]*100 >= score_min2:
        score_min2_counter += 1
    #print("70%+ detection count: ",score_min1_counter)
    #print("85%+ detection count: ",score_min2_counter)
  ...
  for box, color in box_to_color_map.items():
    ...
    #print("testA:",boxes)
    #### Crop at bounding box and save image ####
    #Image, ymin, xmin, ymax, xmax have been passed in
    #image = image.crop(xmin,xmax,ymin,ymax)
    #(ymin,xmin,ymax,xmax)
    ymin_int = int(ymin*200) #Current input images are 200x200
    xmin_int = int(xmin*200)
    ymax_int = int(ymax*200)
    xmax_int = int(xmax*200)
    ...
    image_cropped.save('C:/Users/Jared/Desktop/ECEN404/hello2/TensorFlow/workspace/training_demo/output/test/'+counterStr+'.jpg')
    ...
    draw_bounding_box_on_image_array(
        ...
        ymax,
        xmax,
        color='white', #This line modifies bounding box color
        thickness=1 if skip_boxes else line_thickness,
...
detect_fn = tf.saved_model.load('C:/Users/Jared/Desktop/ECEN404/hello2/TensorFlow/workspace/training_demo/exported-models/my_model/saved_model')
end_time = time.time()
...
import os
path = 'C:/Users/Jared/Desktop/ECEN404/hello2/TensorFlow/workspace/training_demo/output/test'
